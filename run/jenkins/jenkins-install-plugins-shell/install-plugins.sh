...
REF_DIR=${REF:-../plugins}
# JENKINS_UC=${JENKINS_UC_REF:-https://updates.jenkins.io}
JENKINS_UC=${JENKINS_UC_REF:-http://mirror.esuni.jp/jenkins/updates}

JENKINS_WAR=${JENKINS_WAR_PATH:-../jenkins.war}
FAILED="$REF_DIR/failed-plugins.txt"

. ${JENKINS_SUPPORT:-./jenkins-support}
